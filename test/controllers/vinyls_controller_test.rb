...
class VinylsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vinyl" do
    assert_difference('Vinyl.count') do
      post vinyls_url, params: { vinyl: { artist: @vinyl.artist, description: @vinyl.description, genre: @vinyl.genre, name: @vinyl.name, price: @vinyl.price, seller_id: @vinyl.seller_id, year: @vinyl.year } }
    end
  ...
  test "should update vinyl" do
    patch vinyl_url(@vinyl), params: { vinyl: { artist: @vinyl.artist, description: @vinyl.description, genre: @vinyl.genre, name: @vinyl.name, price: @vinyl.price, seller_id: @vinyl.seller_id, year: @vinyl.year } }
